...
Channels wrap django's native async support, allowing django projects to handle
not only http, but protocols that require long-running connections too -
...
Scope is a set of details about a single incoming connection - such as the path a web request
